...
from core.models import OrderStatus, UserProfile, Place, Area, Cluster, Village, District, State, Shop, Item, OrderItem, Order, Address, Coupon, UserProfile, Variation, FavoriteShops, FavoritePlaces
